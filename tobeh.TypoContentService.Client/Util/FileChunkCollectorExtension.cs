...
namespace tobeh.TypoContentService.Client.Util;
...
public static class FileChunkCollectorExtension
{
    ...
    public static List<FileChunkMessage> CreateByteChunks(byte[] bytes, string fileName, string fileType)
    {
        var byteChunks = bytes.Chunk(64 * 1024);
